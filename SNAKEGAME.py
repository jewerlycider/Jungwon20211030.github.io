...
pygame.init()
pygame.mixer.init()
pygame.mixer.music.load('/Users/parkjungwon/Desktop/visual media programming/assignments_code/Ghostrifter Official - Afternoon Nap.mp3')
...
class Game(object):
    ...
    def draw_info(self, length, speed, screen):
        ...
        font_path = resource_path("/Users/parkjungwon/Desktop/visual media programming/assignments_code/NanumGothicCoding-Bold.ttf")
